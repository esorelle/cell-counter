...
def get_chamber_cell_counts_bf(input_img, img_name, gauss_blur_sigma, window_thresh, scaling_thresh, min_blob_area, max_blob_area, min_blob_extent, tophat_selem, min_cell_area, max_cell_area, save_process_pics):
    ...
    for c_center in c_centers:
        ...
        row_rect_vert2 = (c_int_tup[0] + 96, c_int_tup[1] - 139)    # +40, -100
        row_text_regions.append(img_rot[c_int_tup[1] - 171:c_int_tup[1] - 139, c_int_tup[0] + 44:c_int_tup[0] + 96])
        # rect for col number
        col_rect_vert1 = (c_int_tup[0] - 96, c_int_tup[1] - 71)    # -148, -30
        col_rect_vert2 = (c_int_tup[0] - 42, c_int_tup[1] - 40)      # -98, -2
        col_text_regions.append(img_rot[c_int_tup[1] - 71:c_int_tup[1] - 40, c_int_tup[0] - 96:c_int_tup[0] - 42])
        # apt region
