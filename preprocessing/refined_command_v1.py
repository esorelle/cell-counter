...
import click
from refined_process_v1 import flip_horizontal, _check_dtype_supported, remove_large_objects, get_chamber_cell_counts_bf, process_directory_relative_id
...
@click.command('count_command',
    ...
    and defaults.""")
@click.option('--flip', default=False, show_default=True,
...
@click.option('--min_blob_area', type=int, default=2500, show_default=True,
...
@click.option('--min_blob_extent', type=float, default=0.5, show_default=True,
    help="""sets min pct of bounding box blob must occupy (>50% for chambers)""")
...
@click.option('--min_cell_area', default=40, show_default=True,
