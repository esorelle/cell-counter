...
@click.option(
    '--scaling_thresh', type=int, default=247, show_default=True,
    help="""sets value threshold for initial edge creation post-background norm""")
@click.option(
    '--min_blob_area', type=int, default=2000, show_default=True,
    help="""sets minimum area of detected blob for chamber detection""")  # set back to 1500 if needed
@click.option(
    '--max_blob_area', type=int, default=15500, show_default=True,
